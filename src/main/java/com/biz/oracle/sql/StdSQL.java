...
public class StdSQL {
	...
	public static final String STD_INSERT = " INSERT INTO tbl_student VALUES( #{st_num}, #{st_name}, "
			+ " #{st_grade}, #{st_tel}) ";
	...
	public static final String STD_UPDATE = " UPDATE tbl_student SET st_name = #{st_name}, st_grade = #{st_grade}, "
			+ " st_tel = #{st_tel} WHERE st_num = #{st_num} ";
